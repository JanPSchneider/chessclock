...
// FOSCSEL
#pragma config FNOSC = PRI              // Initial Oscillator Source Selection Bits (External Oscillator (PRI))
...
#pragma config FWDTEN = OFF              // Watchdog Timer Enable bit (Watchdog timer NOT always enabled)
